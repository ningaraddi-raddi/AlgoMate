        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-4">
          <div className={`w-full max-w-md rounded-3xl shadow-2xl p-8 lg:p-10 transform transition-all duration-500 hover:scale-[1.01] border animate-slide-in-right ${isDarkTheme ? 'bg-gray-950 border-gray-700' : 'bg-white border-gray-300'}`}>
            ...
            <form onSubmit={handleRegister} className="space-y-6">
              ...
              <button
                type="submit"
                className={`w-full rounded-2xl bg-gradient-to-r from-green-600 to-emerald-600 px-6 py-3 font-bold text-white shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 ${isDarkTheme ? 'focus:ring-offset-gray-950' : 'focus:ring-offset-white'}`}
              >
                Register
              </button>
            </form>
