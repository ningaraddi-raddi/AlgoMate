...
//         const steps = [];
//         const workingArray = initialArray.map((val, i) => ({ value: val, color: '#60A5FA', id: i }));
...
//             codeLine: 3,
//             array: JSON.parse(JSON.stringify(workingArray)),
//             shiftingIndices: workingArray.map((_, i) => i)
//         });

//         // Shift elements
//        for (let i = workingArray.length - 1; i >= 0; i--) {
//     // Highlight the element to be shifted
//     const preShiftArray = JSON.parse(JSON.stringify(workingArray));
//     preShiftArray[i].color = '#F472B6'; // Pink highlight
//     steps.push({
...
//     workingArray[i + 1] = { ...workingArray[i] };  // copy element
//     workingArray[i + 1].color = '#A78BFA'; // Purple for shifted

//     const postShiftArray = JSON.parse(JSON.stringify(workingArray));
//     steps.push({
//         description: `Shift element from index ${i} to ${i + 1}.`,
//         codeLine: 4,
//         array: postShiftArray
//     });

//     // Reset color
//     workingArray[i + 1].color = '#60A5FA';
// }

        
//         // Prepare to insert
//         const emptySlotArray = JSON.parse(JSON.stringify(workingArray));
//         emptySlotArray[0] = { value: '', color: '#34D399', id: 'new' }; // Green for new slot
//         steps.push({
//             description: "Space is now available at the front.",
//             codeLine: 7,
//             array: emptySlotArray
//         });
...
//         generateAnimationSteps(initialData, valueToInsert);
//         setIsPlaying(true);
//     };
...
//                 <div className="w-2/3 bg-white rounded-lg shadow-lg p-6 flex flex-col items-center justify-center">
//                     <div className="w-full h-64 flex items-center justify-center">
//                         {arrayState.length > 0 ? (
//                             <div className="flex items-start justify-center" style={{ perspective: '1000px' }}>
//                                 {arrayState.map((item, index) => (
//                                     <div key={item.id} className="flex flex-col items-center transition-transform duration-500" style={{ transform: `translateX(${index * 80}px)` }}>
//                                         <div 
//                                             className="w-16 h-16 rounded-lg flex items-center justify-center text-xl font-bold text-white shadow-lg transition-all duration-500"
//                                             style={{ backgroundColor: item.color }}
//                                         >
//                                             {item.value}
//                                         </div>
//                                         <span className="mt-2 text-sm font-mono text-gray-500">{index}</span>
//                                     </div>
//                                 ))}
//                             </div>
//                         ) : (
...
//                         )}
//                     </div>
//                     <p className="mt-8 text-center text-lg h-12 font-medium text-gray-700">
