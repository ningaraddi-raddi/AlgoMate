...
//     const fixedHeight = 600; // <- Changed to 600px as requested
...
//       let scaledHeadArrowLength = headArrowLength * zoom;
...
//         const isCurrent = index === currentStep?.nodeIndex;
        
//         // Draw the node container
...
//       // Draw nullptr at the end
//       if (nodeCount > 0) {
//         ctx.fillStyle = '#4B5563';
//         ctx.font = `bold ${14 * zoom}px sans-serif`;
//         ctx.textAlign = 'left';
//         ctx.fillText('nullptr', x, y);
//       }
//     };
...
//             For better viewing, do not cross 10-15 nodes.
//           </p>
//         </div>
//       </div>
...
//             ref={canvasRef} 
//             className="w-full"
//             style={{ height: '500px' }} // <- Fixed height to 600px
